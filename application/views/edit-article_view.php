<div class='w-50 mx-auto text-center'>
    <form method='POST' id='form-edit-article'>
        ...
        <textarea class="input-group-prepend form-control mb-2 w-75 mx-auto border-lime" rows='2'placeholder='Краткое содержание' name='summary' required> <?php echo $data['summary']; ?></textarea>
