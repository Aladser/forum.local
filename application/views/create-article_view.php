<div class='w-50 mx-auto text-center'>
    <form method='POST' id='form-create-article'>
        ...
        <input type="text" class='d-block mx-auto ps-3 p-2 mb-2 w-75 text-secondary border-lime' name="title" placeholder='Заголовок' required>
        <textarea class="input-group-prepend form-control mb-2 w-75 mx-auto text-secondary border-lime" rows='2'placeholder='Краткое содержание' name='summary' required></textarea>
        <textarea class="input-group-prepend form-control mb-2 w-75 mx-auto text-secondary border-lime" rows='10'placeholder='Содержание' name='content' required></textarea>
