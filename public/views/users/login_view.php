<div class='container text-center'>
    ...
    <form class='form mx-auto' method="POST" action=<?=$routes['auth'];?>>
        ...
        <input type="submit" class='form-font ref-color border-0 p-3 mb-2 w-100' value="Войти">
        <a href=<?=$routes['home'];?> class='text-decoration-none'><div class='form-font ref-color mx-auto p-3 w-100'>Назад</div></a>
    </form>
